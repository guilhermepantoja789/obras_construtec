...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-slate-200 antialiased bg-slate-900 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] relative">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div>
                <a href="{{ route('home') }}" class="flex flex-col items-center gap-3 transition-transform hover:scale-105 duration-300">
            ...
            <a href="{{ route('home') }}" class="mt-8 text-sm font-medium text-amber-500 hover:text-amber-400 transition-colors">Voltar ao site</a>
            <p class="mt-3 text-sm text-slate-500">&copy; {{ date('Y') }} Construtec. Todos os direitos reservados.</p>
        </div>
    </body>
</html>
