                ...
                <form action="{{ route('obras.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="nome" name="nome" type="text" class="mt-1 block w-full" :value="old('nome')" required autofocus placeholder="Ex: Edifício Horizonte" />
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-white/5 rounded-xl border border-white/5">
                            <div class="md:col-span-1">
                                ...
                                <x-text-input id="cep" name="cep" type="text" class="mt-1 block w-full" :value="old('cep')" placeholder="00000-000" maxlength="9" onblur="buscarCep(this.value)" />
                                <x-input-error class="mt-2" :messages="$errors->get('cep')" />
                            </div>
                            <div class="md:col-span-2">
                                <x-input-label for="logradouro" :value="__('Logradouro')" />
                                <x-text-input id="logradouro" name="logradouro" type="text" class="mt-1 block w-full" :value="old('logradouro')" placeholder="Rua, Avenida..." />
                                <x-input-error class="mt-2" :messages="$errors->get('logradouro')" />
                            </div>
                            <div>
                                <x-input-label for="bairro" :value="__('Bairro')" />
                                <x-text-input id="bairro" name="bairro" type="text" class="mt-1 block w-full" :value="old('bairro')" />
                                <x-input-error class="mt-2" :messages="$errors->get('bairro')" />
                            </div>
                            <div>
                                <x-input-label for="cidade" :value="__('Cidade')" />
                                <x-text-input id="cidade" name="cidade" type="text" class="mt-1 block w-full" :value="old('cidade')" />
                                <x-input-error class="mt-2" :messages="$errors->get('cidade')" />
                            </div>
                            <div>
                                <x-input-label for="estado" :value="__('Estado (UF)')" />
                                <x-text-input id="estado" name="estado" type="text" class="mt-1 block w-full" :value="old('estado')" maxlength="2" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="localizacao" name="localizacao" type="text" class="mt-1 block w-full" :value="old('localizacao')" placeholder="Ex: Próximo ao metrô" />
                            <x-input-error class="mt-2" :messages="$errors->get('localizacao')" />
                        </div>

                        <div>
                            <x-input-label for="data_inicio" :value="__('Data de Início')" />
                            <x-text-input id="data_inicio" name="data_inicio" type="date" class="mt-1 block w-full" :value="old('data_inicio')" />
                            <x-input-error class="mt-2" :messages="$errors->get('data_inicio')" />
                        </div>

                        <div>
                            <x-input-label for="data_fim_prevista" :value="__('Previsão de Término')" />
                            <x-text-input id="data_fim_prevista" name="data_fim_prevista" type="date" class="mt-1 block w-full" :value="old('data_fim_prevista')" />
                            <x-input-error class="mt-2" :messages="$errors->get('data_fim_prevista')" />
                        </div>

                        <div>
                            <x-input-label for="prazo_dias" :value="__('Prazo Total (Dias)')" />
                            <x-text-input id="prazo_dias" name="prazo_dias" type="number" class="mt-1 block w-full" :value="old('prazo_dias')" placeholder="Ex: 180" />
                        ...
                        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white/5 rounded-xl border border-white/5">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-text-input id="contratante" name="contratante" type="text" class="mt-1 block w-full" :value="old('contratante')" placeholder="Ex: Nome da Empresa ou Cliente" />
                                    <x-input-error class="mt-2" :messages="$errors->get('contratante')" />
                                </div>
                                <div>
                                    <x-input-label for="cnpj_contratante" :value="__('CNPJ do Contratante')" />
                                    <x-text-input id="cnpj_contratante" name="cnpj_contratante" type="text" class="mt-1 block w-full cnpj-mask" :value="old('cnpj_contratante')" placeholder="00.000.000/0000-00" />
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <x-text-input id="empresa_contratada" name="empresa_contratada" type="text" class="mt-1 block w-full" :value="old('empresa_contratada')" placeholder="Ex: Nome da sua Construtora" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="cnpj_empresa_contratada" name="cnpj_empresa_contratada" type="text" class="mt-1 block w-full cnpj-mask" :value="old('cnpj_empresa_contratada')" placeholder="00.000.000/0000-00" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="engenheiro_responsavel" name="engenheiro_responsavel" type="text" class="mt-1 block w-full" :value="old('engenheiro_responsavel')" placeholder="Ex: Ronaldo Souza 24958-AM" />
                    ...
                    <div class="mt-8 flex items-center justify-end gap-4 border-t border-white/5 pt-6">
                        ...
                        <x-primary-button id="btn-submit">{{ __('Criar Obra') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
