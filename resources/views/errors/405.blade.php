...
<body class="min-h-screen bg-slate-950 text-white flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 text-center">
        <p class="text-xs font-black text-amber-500 uppercase tracking-widest mb-2">Erro 405</p>
        <h1 class="text-2xl font-black mb-3">Ação não permitida</h1>
        <p class="text-sm text-slate-300 mb-6">Essa ação não pode ser executada nesta URL.</p>
